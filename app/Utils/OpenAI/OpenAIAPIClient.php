...
class OpenAIAPIClient
{
     ...
     * @return string
     */
    public function fetchAnswer(string $prompt, string $encodedImage): string|array
    {
        $payload = [
            "messages" => [
                [
    ...
    * @param string $prompt プロンプトテキスト
    * @return string | array AIからの回答
    */
    public function fetchAnswerOnlyPrompt(string $prompt): string|array
    {
        $payload = [
            "messages" => [
                [
